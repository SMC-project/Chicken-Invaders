...
void Wave::drawWave_asteroid(RenderWindow& map, Asteroid asteroidVect[10][10])
{
	for (int i = 0; i < 5; i++)
		for (int j = 0; j < 6; j++)
...
void Wave::setSprite_asteroid1(Texture& asteroid, Asteroid asteroidVect[10][10])
{
	for (int i = 0; i < 5; i++)
		for (int j = 0; j < 6; j++)
		{
...
void Wave::thirdWave_Position(Asteroid asteroidVect[10][10])
{
	srand(time(NULL));
	for (int i = 0; i < 5; i++)
		for (int j = 0; j < 6; j++)
...
void Wave::thirdWave_Movement(Asteroid asteroidVect[10][10])
{
	for (int i = 0; i < 5; i++)
		for (int j = 0; j < 6; j++)
		{
